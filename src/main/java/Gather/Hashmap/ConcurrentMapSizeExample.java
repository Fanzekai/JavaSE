...
public class ConcurrentMapSizeExample {
    public static void main(String[] args) {
        ...
        // 获取总元素个数
        int totalSize = getTotalSize(concurrentMap);
    ...
    // 计算总的元素个数
    static int getTotalSize(ConcurrentHashMap<String, Integer> concurrentMap) {
        int[] totalSize = new int[1];
        concurrentMap.forEach(100, (k, v) -> totalSize[0]++);
        return totalSize[0];
    }
}
